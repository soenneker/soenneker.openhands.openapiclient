...
#nullable enable
        public List<global::Soenneker.OpenHands.OpenApiClient.Models.TaskObservationOutput.TaskObservationOutput_content>? Content { get; set; }
#nullable restore
#else
        public List<global::Soenneker.OpenHands.OpenApiClient.Models.TaskObservationOutput.TaskObservationOutput_content> Content { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class TaskObservationOutput_content : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.OpenHands.OpenApiClient.Models.TaskObservationOutput.TaskObservationOutput_content"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.OpenHands.OpenApiClient.Models.TaskObservationOutput.TaskObservationOutput_content CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.OpenHands.OpenApiClient.Models.TaskObservationOutput.TaskObservationOutput_content();
