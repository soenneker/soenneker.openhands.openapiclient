...
namespace Soenneker.OpenHands.OpenApiClient.Models
{
    ...
    public partial class PlanningFileEditorObservationInputContentItem : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenHands.OpenApiClient.Models.PlanningFileEditorObservationInputContentItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenHands.OpenApiClient.Models.PlanningFileEditorObservationInputContentItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var result = new global::Soenneker.OpenHands.OpenApiClient.Models.PlanningFileEditorObservationInputContentItem();
